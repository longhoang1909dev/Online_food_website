...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1833144670ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=dishes">`online_food`.`dishes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=res_category">`online_food`.`res_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=restaurant">`online_food`.`restaurant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=users_orders">`online_food`.`users_orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=remark">`online_food`.`remark`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=users">`online_food`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_food&table=admin">`online_food`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbjobsportal&table=employer">`dbjobsportal`.`employer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbjobsportal&table=application">`dbjobsportal`.`application`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbjobsportal&table=categories">`dbjobsportal`.`categories`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7c495336753d2e2e607648416335307d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="online_food" targettable="remark">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `remark`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="remark">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `remark`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="res_category">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `res_category`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="restaurant">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `restaurant`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="users_orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `remark`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="dishes">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `dishes`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="restaurant">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT rand(6) FROM dishes;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_food" targettable="dishes">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM dishes
ORDER BY RAND(6)
LIMIT 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
